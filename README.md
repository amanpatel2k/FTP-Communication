...
4. Once the server and client are both running, then you can start sending commands, such as GET $lt1filename&gt, PUT <filename>, LS, or QUIT, from the client to the server
